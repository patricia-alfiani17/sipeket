                            ...
                            <div class="card card-outline card-secondary mb-3">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('ambang_tidak_lulus') is-invalid @enderror" id="ambang_tidak_lulus" name="ambang_tidak_lulus" value="{{ old('ambang_tidak_lulus', 59) }}" min="0" max="100" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('ambang_pertimbangan_min') is-invalid @enderror" id="ambang_pertimbangan_min" name="ambang_pertimbangan_min" value="{{ old('ambang_pertimbangan_min', 60) }}" min="0" max="100" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" class="form-control @error('ambang_pertimbangan_max') is-invalid @enderror" id="ambang_pertimbangan_max" name="ambang_pertimbangan_max" value="{{ old('ambang_pertimbangan_max', 74) }}" min="0" max="100" required>
